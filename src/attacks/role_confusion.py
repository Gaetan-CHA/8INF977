"""Role\ Confusion\ /\ Role\ Hijack
Category: Role\ hijacking\ /\ persona\ attack
Source: AgentDojo\ /\ NeurIPS\ 2024

Short description:
Forcer\ le\ modèle\ à\ se\ comporter\ comme\ une\ autre\ entité\ \(system,\ admin\.\.\.\)\.
...
def generate(context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        "prompt": prompt,
        "metadata": {
            "attack_id": "role_confusion\.py",
            "title": "Role\ Confusion\ /\ Role\ Hijack",
            "source": "AgentDojo\ /\ NeurIPS\ 2024"
        }
    }
