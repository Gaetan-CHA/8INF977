"""Soft-Prompt\ Threats
Category: Embedding\ /\ token-level\ perturbation
Source: NeurIPS\ 2024\ \ Soft-Prompt\ Threats

Short description:
Attaques\ utilisant\ modification\ de\ soft-prompts\ ou\ perturbation\ d'embeddings\.
...
def generate(context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        "prompt": prompt,
        "metadata": {
            "attack_id": "soft_prompt_threat\.py",
            "title": "Soft-Prompt\ Threats",
            "source": "NeurIPS\ 2024\ \ Soft-Prompt\ Threats"
        }
    }
