"""Prompt\ Adversarial\ Tuning\ \(PAT\ /\ APO\)
Category: Adversarial\ optimization
Source: NeurIPS\ 2024\ \ Fight\ Back\ Against\ Jailbreaking\ via\ Prompt\ Adversarial\ Tuning

Short description:
Recherche\ automatique\ \(évolutionnaire/optimisation\)\ de\ prompts\ déclencheurs\.
...
def generate(context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return {
        "prompt": prompt,
        "metadata": {
            "attack_id": "prompt_adversarial_tuning\.py",
            "title": "Prompt\ Adversarial\ Tuning\ \(PAT\ /\ APO\)",
            "source": "NeurIPS\ 2024\ \ Fight\ Back\ Against\ Jailbreaking\ via\ Prompt\ Adversarial\ Tuning"
        }
    }
