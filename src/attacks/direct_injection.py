...
Category: Prompt\ manipulation\ \(direct\)
Source: AgentDojo\ /\ NeurIPS\ 2024\ \(prompt\ injection\ exposition\)

Short description:
Injection\ classique\ dans\ le\ texte\ utilisateur\ \(e\.g\.\ 'Ignore\ prior\ instructions'\)\.
